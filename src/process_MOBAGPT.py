...
def set_args():
    ...
    parser.add_argument("--train_src_path", type=str, default="data/general/general_train.src")
    parser.add_argument("--train_tgt_path", type=str, default="data/general/general_train.tgt")
    parser.add_argument("--train_json_path", type=str, default="data/general/general_train.json")
    parser.add_argument("--valid_src_path", type=str, default="data/general/general_valid.src")
    parser.add_argument("--valid_tgt_path", type=str, default="data/general/general_valid.tgt")
    parser.add_argument("--valid_json_path", type=str, default="data/general/general_valid.json")
...
if __name__ == '__main__':
    ...
    with open('MOBAGPT.json','w', encoding='utf-8') as f:
        f.write(final_str)
