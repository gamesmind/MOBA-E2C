...
def set_args():
    ...
    parser.add_argument("--train_src_path", type=str, default="data/adaptive/adaptive2_train.src")
    parser.add_argument("--train_tgt_path", type=str, default="data/adaptive/adaptive2_train.tgt")
    parser.add_argument("--train_json_path", type=str, default="data/adaptive/adaptive2_train.json")
    parser.add_argument("--valid_src_path", type=str, default="data/adaptive/adaptive2_valid.src")
    parser.add_argument("--valid_tgt_path", type=str, default="data/adaptive/adaptive2_valid.tgt")
    parser.add_argument("--valid_json_path", type=str, default="data/adaptive/adaptive2_valid.json")
...
if __name__ == '__main__':
    ...
    with open('adaptive2.json','w', encoding='utf-8') as f:
        f.write(final_str)
